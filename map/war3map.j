...
function CreateRegions takes nothing returns nothing
    ...
    set gg_rct_TheMainBase=Rect(- 3072.0, - 11360.0, 1024.0, - 8192.0)
...
function main takes nothing returns nothing
    call SetCameraBounds(- 2304.0 + GetCameraMargin(CAMERA_MARGIN_LEFT), - 11776.0 + GetCameraMargin(CAMERA_MARGIN_BOTTOM), 256.0 - GetCameraMargin(CAMERA_MARGIN_RIGHT), - 9216.0 - GetCameraMargin(CAMERA_MARGIN_TOP), - 2304.0 + GetCameraMargin(CAMERA_MARGIN_LEFT), - 9216.0 - GetCameraMargin(CAMERA_MARGIN_TOP), 256.0 - GetCameraMargin(CAMERA_MARGIN_RIGHT), - 11776.0 + GetCameraMargin(CAMERA_MARGIN_BOTTOM))
...
function config takes nothing returns nothing
    ...
    call DefineStartLocation(0, - 423.3, - 10182.4)
    call DefineStartLocation(1, - 728.9, - 11249.9)
    call DefineStartLocation(2, - 1906.1, - 11126.8)
    call DefineStartLocation(3, 64.0, - 9408.0)
    call DefineStartLocation(4, - 1290.5, - 11470.3)
    call DefineStartLocation(5, - 1837.1, - 10596.5)
    // Player setup
