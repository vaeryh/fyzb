...
hashtable Mouse___Hash= InitHashtable()
integer array Mouse_ItemBarIndex
...
//↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓Function↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓
//离开
function Mouse___Leave_Actions takes nothing returns nothing
 local player p= DzGetTriggerUIEventPlayer()
 local integer id= GetPlayerId(p)
	set Mouse_ItemBarIndex[id]=- 1
	//运行触发器
	call TriggerExecute(Mouse_ItemBarLeave)
endfunction
//进入
function Mouse___Enter_Actions takes nothing returns nothing
 local player p= DzGetTriggerUIEventPlayer()
 local integer id= GetPlayerId(p)
	set Mouse_ItemBarIndex[id]=LoadInteger(Mouse___Hash, DzGetTriggerUIEventFrame(), 0)
	//运行触发器
	call TriggerExecute(Mouse_ItemBarEnter)
endfunction
//鼠标进入、离开物品栏
function Mouse___Init_A_Actions takes nothing returns nothing
 local integer lopA
 local integer frame
	set lopA=0
	loop
	exitwhen lopA > 5
		...
		call SaveInteger(Mouse___Hash, frame, 0, lopA) //关联序号
		//call DzFrameSetScriptByCode(frame, 1, function Click_Actions, false) // 鼠标点击
		call DzFrameSetScriptByCode(frame, 2, function Mouse___Enter_Actions, true) // 鼠标进入
call DzFrameSetScriptByCode(frame, 3, function Mouse___Leave_Actions, true) // 鼠标离开
...
//↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑Function↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑
//↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓Function↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓
function Mouse___Init takes nothing returns nothing
	call Mouse___Init_A_Actions() //鼠标进入物品栏
endfunction
// scope Mouse ends
...
call Mouse___Init_A_Actions() // INLINED!!
