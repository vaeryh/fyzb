...
//↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓Function↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓
// scope Attack begins
function Attack___xG_ability_lua takes nothing returns nothing
	
endfunction
function Attack___Init takes nothing returns nothing
...
//↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓Function↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓
// scope Armor begins
function Armor___xG_ability_lua takes nothing returns nothing
	
endfunction
function Armor___Init takes nothing returns nothing
...
function StrAgiInt___xG_ability_lua takes nothing returns nothing
	
endfunction
function StrAgiInt___Init takes nothing returns nothing
...
function yh___FrameEvent_Evenr_Pressed takes nothing returns nothing
	call TriggerExecute(yh_FrameEvent[1])
endfunction
// FrameEvent_Mouse_Enter=0,frameevent,2,鼠标进入
function yh___FrameEvent_Mouse_Enter takes nothing returns nothing
	call TriggerExecute(yh_FrameEvent[2])
endfunction
// FrameEvent_Mouse_Leave=0,frameevent,3,鼠标离开
function yh___FrameEvent_Mouse_Leave takes nothing returns nothing
	call TriggerExecute(yh_FrameEvent[3])
endfunction
// FrameEvent_Mouse_Up=0,frameevent,4,鼠标释放
function yh___FrameEvent_Mouse_Up takes nothing returns nothing
	call TriggerExecute(yh_FrameEvent[4])
endfunction
// FrameEvent_Mouse_Down=0,frameevent,5,鼠标按下
function yh___FrameEvent_Mouse_Down takes nothing returns nothing
	call TriggerExecute(yh_FrameEvent[5])
endfunction
// FrameEvent_Mouse_Wheel=0,frameevent,6,鼠标轮滚
function yh___FrameEvent_Mouse_Wheel takes nothing returns nothing
	call TriggerExecute(yh_FrameEvent[6])
endfunction
// FrameEvent_Checkbox_Checked=0,frameevent,7,复选框被选中
function yh___FrameEvent_Checkbox_Checked takes nothing returns nothing
	call TriggerExecute(yh_FrameEvent[7])
endfunction
// FrameEvent_Checkbox_Unchecked=0,frameevent,8,复选框取消选中
function yh___FrameEvent_Checkbox_Unchecked takes nothing returns nothing
	call TriggerExecute(yh_FrameEvent[8])
endfunction
// FrameEvent_Editbox_Text_Changed=0,frameevent,9,捕获输入框文字变化
function yh___FrameEvent_Editbox_Text_Changed takes nothing returns nothing
	call TriggerExecute(yh_FrameEvent[9])
endfunction
// FrameEvent_Popupmenu_Item_Change_Start=0,frameevent,10,弹出菜单开始
function yh___FrameEvent_Popupmenu_Item_Change_Start takes nothing returns nothing
	call TriggerExecute(yh_FrameEvent[10])
endfunction
// FrameEvent_Popupmenu_Item_Changed_Start=0,frameevent,11,弹出菜单结束
function yh___FrameEvent_Popupmenu_Item_Changed_Start takes nothing returns nothing
	call TriggerExecute(yh_FrameEvent[11])
endfunction
// FrameEvent_Mouse_Doubleclick=0,frameevent,12,鼠标双击
function yh___FrameEvent_Mouse_Doubleclick takes nothing returns nothing
	call TriggerExecute(yh_FrameEvent[12])
endfunction
// FrameEvent_Sprite_Anim_Update=0,frameevent,13,精灵动画更新
function yh___FrameEvent_Sprite_Anim_Update takes nothing returns nothing
	call TriggerExecute(yh_FrameEvent[13])
endfunction
//注册Frame UI事件回调
function yh_FrameSetScriptByCode takes nothing returns nothing
	if yh_integer1 == 1 then
		call DzFrameSetScriptByCode(yh_frame1, 1, function yh___FrameEvent_Evenr_Pressed, false)
	elseif yh_integer1 == 2 then
		call DzFrameSetScriptByCode(yh_frame1, 2, function yh___FrameEvent_Mouse_Enter, false)
	elseif yh_integer1 == 3 then
		call DzFrameSetScriptByCode(yh_frame1, 3, function yh___FrameEvent_Mouse_Leave, false)
	elseif yh_integer1 == 4 then
		call DzFrameSetScriptByCode(yh_frame1, 4, function yh___FrameEvent_Mouse_Up, false)
	elseif yh_integer1 == 5 then
		call DzFrameSetScriptByCode(yh_frame1, 5, function yh___FrameEvent_Mouse_Down, false)
	elseif yh_integer1 == 6 then
		call DzFrameSetScriptByCode(yh_frame1, 6, function yh___FrameEvent_Mouse_Wheel, false)
	elseif yh_integer1 == 7 then
		call DzFrameSetScriptByCode(yh_frame1, 7, function yh___FrameEvent_Checkbox_Checked, false)
	elseif yh_integer1 == 8 then
		call DzFrameSetScriptByCode(yh_frame1, 8, function yh___FrameEvent_Checkbox_Unchecked, false)
	elseif yh_integer1 == 9 then
		call DzFrameSetScriptByCode(yh_frame1, 9, function yh___FrameEvent_Editbox_Text_Changed, false)
	elseif yh_integer1 == 10 then
		call DzFrameSetScriptByCode(yh_frame1, 10, function yh___FrameEvent_Popupmenu_Item_Change_Start, false)
	elseif yh_integer1 == 11 then
		call DzFrameSetScriptByCode(yh_frame1, 11, function yh___FrameEvent_Popupmenu_Item_Changed_Start, false)
	elseif yh_integer1 == 12 then
		call DzFrameSetScriptByCode(yh_frame1, 12, function yh___FrameEvent_Mouse_Doubleclick, false)
	elseif yh_integer1 == 13 then
		call DzFrameSetScriptByCode(yh_frame1, 13, function yh___FrameEvent_Sprite_Anim_Update, false)
	endif
endfunction
//------------------------------------------------------------------------
//     native DzGetTriggerUIEventPlayer takes nothing returns player
