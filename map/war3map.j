...
function CreateNeutralHostile takes nothing returns nothing
    ...
    local trigger t
    local real life
    set u=CreateUnit(p, 'h002', 148.2, - 8503.3, 293.940)
    set u=CreateUnit(p, 'h002', 17.0, - 8619.3, 293.940)
    set u=CreateUnit(p, 'h002', 283.6, - 8387.5, 293.940)
    set u=CreateUnit(p, 'h002', 419.7, - 8268.1, 293.940)
...
//---------------------------------------------------------------
//设置单位属性GetUnitState
function yh_getUnitState takes nothing returns nothing
	set yh_real1=GetUnitState(yh_unit, yh_unitstate)
endfunction
//设置单位属性SetUnitState
function yh_setUnitState takes nothing returns nothing
...
//===========================================================================
function AtkUnit__Init_Actions takes nothing returns nothing
    
endfunction
    
function AtkUnit__Init takes nothing returns nothing
    call AtkUnit__Init_Actions()
endfunction
// scope AtkUnit ends
...
call AtkUnit__Init_Actions() // INLINED!!
